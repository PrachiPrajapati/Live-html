...
$(document).ready(function () {
  $(document).on('click', '.read-more-btn button', function (e) {
    ...
    if($(this).hasClass('close_section')){
      ...
      // $(this).parents('.msg-txt').removeClass('show-txt');
      $(this).parents('.msg-txt').find(".more-msg-blk").slideUp(500);
      ...
      // $(this).parents('.msg-txt').addClass('show-txt');
  ...
  $(document).on('click', '.our-benefactors-sec .read-more-btn .button, .our-scholars-sec .read-more-btn button',  function () {
    $readmore = $(this);
    setTimeout(function(){
      window.scrollTo(0, $readmore.parent().parent().offset().top - 200);
    }, 500);
  });
