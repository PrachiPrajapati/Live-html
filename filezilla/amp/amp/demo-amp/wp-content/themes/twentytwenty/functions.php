...
function home_banner() {
	$homeLabels = array(
	'name' => _x( 'Home Banner', 'Post Type General Name', 'home' ),
	'singular_name' => _x( 'Home Banner', 'Post Type Singular Name', 'home' ),
	'menu_name' => __( 'Home Banner', 'home' ),
	'parent_item_colon' => __( 'Parent Home Banner', 'home' ),
	'all_items' => __( 'All Home Banner', 'home' ),
	'view_item' => __( 'View Home Banner', 'home' ),
	'add_new_item'	=> __( 'Add New Home Banner', 'home' ),
	'add_new' => __( 'Add New Home Banner', 'home' ),
	'edit_item' => __( 'Edit Home Banner', 'home' ),
	'update_item' => __( 'Update Home Banner', 'home' ),
	'search_items' => __( 'Search Home Banner', 'home' ),
	'not_found' => __( 'Not Found', 'home' ),
	'not_found_in_trash' => __( 'Not found in Trash', 'home' ),
	); 
	// Set other options for Custom Post Type 
	$homeArgs = array(
	'label' => __( 'Home Banner', 'home' ),
	'description'	=> __( 'New Home Banner', 'home' ),
	'labels' => $homeLabels,
		...
		if($the_query->have_posts()):?>
				...
				while($the_query->have_posts()) : $the_query->the_post(); ?>
					<?php $thumb = get_the_post_thumbnail_url(); ?>
						<div class="row">
							<div class="col-sm-6">
								<amp-img alt="banner-img" src="<?php the_field('home_banner'); ?>" width="742" height="681" layout="responsive"></amp-img>
							</div>
							<div class="col-sm-6">
								<h1><?php the_title(); ?></h1>
...
function service() {
	...
	'add_new' => __( 'Add New Service', 'service' ),
	...
	'description'	=> __( 'New Service', 'service' ),
		...
		if($the_query->have_posts()):?>
			<div class="row">
				...
				while($the_query->have_posts()) : $the_query->the_post(); ?>
					<?php $thumb = get_the_post_thumbnail_url(); ?>
						<div class="col-sm-4">
		  					<div class="service-subservice-section">
							  	<div class="service-img">
									<amp-img alt="banner-img" src="<?php the_field('service_image');?>" width="88" height="88"></amp-img>
								</div>
								<h3><?php the_title(); ?></h3>
